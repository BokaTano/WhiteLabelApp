...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    var window: UIWindow?
    //add for coordinator implementation
    ...
    func application(_ application: UIApplication,
        ...
        let newsNavCtrl = UINavigationController()
        let listNavCtrl = UINavigationController()
        let addNavCtrl = UINavigationController()
//        let moreNavCtrl = UINavigationController()
        let tabBarController = UITabBarController()

        // send that into our coordinator so that it can display view controllers

        coordinator = AppCoordinator(
            newsCtrl: newsNavCtrl,
            listCtrl: listNavCtrl,
            addCtrl: addNavCtrl,
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "BrettlyPrototype05")
